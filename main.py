...
@peliculas.get("/peliculas_mes/{mes}")
...
@peliculas.get("/peliculas_dia/{dia}")
...
@peliculas.get("/peliculas_score/{titulo_de_la_filmacion}")
...
@peliculas.get("/peliculas_votos/{titulo_de_la_filmacion}")
...
@peliculas.get("/peliculas_actor/{nombre_actor}")
...
@peliculas.get("/peliculas_director/{nombre_director}")
